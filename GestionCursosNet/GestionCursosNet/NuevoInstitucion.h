...
namespace GestionCursosNet {
	...
	/// <summary>
	/// Resumen de NuevoInstitucion
	/// </summary>
	public ref class NuevoInstitucion : public System::Windows::Forms::Form
	{
	public: String^ cnnstring;
	public:
		NuevoInstitucion(String^ Cnnstring)
		{
			InitializeComponent();
			cnnstring = Cnnstring;
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(NuevoInstitucion::typeid));
			...
			this->bunifuImageButton4->Location = System::Drawing::Point(158, 87);
			...
			this->bunifuImageButton3->Location = System::Drawing::Point(72, 87);
			...
			this->bunifuImageButton3->Click += gcnew System::EventHandler(this, &NuevoInstitucion::bunifuImageButton3_Click);
			// 
			// bunifuImageButton2
			// 
			...
			this->bunifuImageButton2->Location = System::Drawing::Point(114, 87);
			...
			this->bunifuImageButton2->Click += gcnew System::EventHandler(this, &NuevoInstitucion::bunifuImageButton2_Click);
			// 
			// btn_guardar
			// 
			...
			this->btn_guardar->Location = System::Drawing::Point(31, 87);
			...
			this->btn_guardar->Click += gcnew System::EventHandler(this, &NuevoInstitucion::btn_guardar_Click);
			// 
			// txt_nombre
			// 
			...
			this->txt_nombre->Location = System::Drawing::Point(31, 168);
			...
			this->txt_nombre->Enter += gcnew System::EventHandler(this, &NuevoInstitucion::txt_nombre_Enter);
			this->txt_nombre->Leave += gcnew System::EventHandler(this, &NuevoInstitucion::txt_nombre_Leave);
			// 
			// txt_codigo
			// 
			...
			this->txt_codigo->Location = System::Drawing::Point(31, 135);
			...
			this->txt_codigo->Enter += gcnew System::EventHandler(this, &NuevoInstitucion::txt_codigo_Enter);
			this->txt_codigo->Leave += gcnew System::EventHandler(this, &NuevoInstitucion::txt_codigo_Leave);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Institucion";
			// 
			// gv_datos
			// 
			...
			this->gv_datos->Location = System::Drawing::Point(31, 209);
			...
			this->gv_datos->Size = System::Drawing::Size(360, 348);
			...
			this->Name = L"NuevoInstitucion";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Institucion";
			this->Load += gcnew System::EventHandler(this, &NuevoInstitucion::NuevoInstitucion_Load);
...
#pragma endregion
	...
	{
		ClassInstitucion^ Institucion = gcnew ClassInstitucion(cnnstring);
		Institucion->institucion = txt_nombre->Text;
		if (Institucion->Ingresar())
		{
	...
	private: System::Void bunifuImageButton3_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		{
			ClassInstitucion^ Institucion = gcnew ClassInstitucion(cnnstring);
			Institucion->cod_institucion = Convert::ToInt32(txt_codigo->Text);
			Institucion->Obtener();
			txt_nombre->Text = Institucion->institucion;
	...
	{
		ClassInstitucion^ Institucion = gcnew ClassInstitucion(cnnstring);
		Institucion->cod_institucion = 0;
		gv_datos->DataSource = Institucion->Buscar();
		PersonalizacionGrid();
	}

	private: System::Void NuevoInstitucion_Load(System::Object^  sender, System::EventArgs^  e)
	{
		CargarGrid();
	}
	private: void PersonalizacionGrid() 
	{
		...
		this->gv_datos->Columns[0]->Width = 150;
		this->gv_datos->Columns[0]->MinimumWidth = 150;
		this->gv_datos->Columns[0]->FillWeight = 50;
		
		this->gv_datos->Columns[1]->HeaderText = "Institucion";
		this->gv_datos->Columns[1]->FillWeight = 600;
	}
