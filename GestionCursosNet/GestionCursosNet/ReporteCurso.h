...
namespace GestionCursosNet {
	...
	/// <summary>
	/// Resumen de ReporteCurso
	/// </summary>
	public ref class ReporteCurso : public System::Windows::Forms::Form
	{
	public: String^ cnnstring;
	public:
		ReporteCurso(String^ Cnnstring)
		{
			InitializeComponent();
			cnnstring = Cnnstring;
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->gv_datos->Location = System::Drawing::Point(27, 111);
			...
			this->txt_filtro->Location = System::Drawing::Point(27, 66);
			...
			this->txt_filtro->Text = L"Curso";
			this->txt_filtro->TextAlign = System::Windows::Forms::HorizontalAlignment::Left;
			this->txt_filtro->Enter += gcnew System::EventHandler(this, &ReporteCurso::txt_filtro_Enter);
			this->txt_filtro->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &ReporteCurso::txt_filtro_KeyUp);
			this->txt_filtro->Leave += gcnew System::EventHandler(this, &ReporteCurso::txt_filtro_Leave);
			// 
			// ReporteCurso
			// 
			...
			this->Name = L"ReporteCurso";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"ReporteCurso";
...
#pragma endregion
	...
	{
		if (txt_filtro->Text != "Curso" || txt_filtro->Text != "")
		{
			ClassCurso^ Curso = gcnew ClassCurso(cnnstring);
			Curso->curso = txt_filtro->Text;
			gv_datos->DataSource = Curso->Reporte();
		}
	}
	private: System::Void txt_filtro_Enter(System::Object^  sender, System::EventArgs^  e) 
	{
		funcionesGenerales->PlaceHolderTextBoxEnter(txt_filtro, "Curso");
	}
	private: System::Void txt_filtro_Leave(System::Object^  sender, System::EventArgs^  e) 
	{
		funcionesGenerales->PlaceHolderTextBoxLeave(txt_filtro, "Curso");
	}
